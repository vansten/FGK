...
CornellBox::CornellBox(Vector3 pos, Vector3 size) {
    redWallMaterial = new DiffuseMaterial(Color(0,0,0), Color(1,0,0), Color(0.0,0.0,0.0), 0, 0.0);
    greenWallMaterial = new DiffuseMaterial(Color(0,0,0), Color(0,1,0), Color(0.0,0.0,0.0), 0, 0.0);
    whiteWallMaterial = new DiffuseMaterial(Color(0,0,0), Color(1,1,1), Color(0.0,0.0,0.0), 0, 0.0);
    blueWallMaterial = new DiffuseMaterial(Color(0,0,0), Color(0,0,1), Color(0.0,0.0,0.0), 0, 0.0);
